# Колодин Антон, 29-я когорта — Финальный проект. Инженер по тестированию плюс
...
def assertion_code_200():
	response_get = post_new_order(data.order_body)
	track = response_get.json()["track"]
	return get_order_from_track(track).status_code

# Проверить, что код ответа равен 200.
def test_get_order_from_track_code_200():
	assert assertion_code_200() == 200
